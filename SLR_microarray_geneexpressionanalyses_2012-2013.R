...
experimentData<-new("MIAME",name="Lisa Cohen, Joshua Voss, Sara Edge",
...
write.table(annotation_dataframe,"annotation_matrix.txt",sep="\t")
...
head(norm_SLR_matrix_shift1_log2)
...
SLR_normExpressionSet_log2<-new("ExpressionSet",exprs=sorted_norm_SLR_matrix_shift1_log2,phenoData=pd,experimentData=experimentData,featureData=an_feature)
...
cmtx<-makeContrasts("varCentralJanFeb13-varLedgeJanFeb13","varSouthJanFeb13-varLedgeJanFeb13","varSouthJanFeb13-varCentralJanFeb13","varCentralJun12-varLedgeJun12","varSouthJun12-varCentralJun12","varLedgeJun12-varSouthJun12","varLedgeOct12-varSouthOct12",levels=design)
fit<-lmFit(SLR_normExpressionSet_log2,design=design)
fit<-eBayes(fit)
fit2<-eBayes(contrasts.fit(lmFit(SLR_normExpressionSet_log2,design),cmtx))
